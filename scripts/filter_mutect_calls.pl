...
$annotFile = $ARGV[0];
$trc = $ARGV[1]; # t_ref_count_col
$tac = $ARGV[2]; # t_alt_count_col
$nrc = $ARGV[3]; # n_ref_count_col
$nac = $ARGV[4]; # n_alt_count_col
$N_ALT_THRESHOLD = $ARGV[5];
$PSHOME = $ARGV[6];
$chooseManuallyFile = $ARGV[7];
